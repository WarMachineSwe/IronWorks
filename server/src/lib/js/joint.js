...
// --------------------------
  ...
  joint.dia.Cell = Backbone.Model.extend({
    ...
    startBatch: function (name, opt) {
      ...
      if (this.graph) {
        this.graph.startBatch(name, joint.util.assign({}, opt, {cell: this}))
      }
      return this
    },
    ...
    stopBatch: function (name, opt) {
      ...
      if (this.graph) {
        this.graph.stopBatch(name, joint.util.assign({}, opt, {cell: this}))
      }
      return this
    }
...
//
  ...
  (function (joint, util, g, V) {
    ...
    function closestIntersection (intersections, refPoint) {
      ...
      return util.sortBy(intersections, function (i) {
        return i.squaredDistance(refPoint)
      })[0]
    }
